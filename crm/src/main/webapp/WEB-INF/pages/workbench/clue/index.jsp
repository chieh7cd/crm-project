...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#saveCreateClueBtn").click(function () {
			...
			var mphoneRegExp=/^0?(13|14|15|17|18|19)[0-9]{9}$/;
			if(!mphoneRegExp.test(mphone)){
				alert("请输入正确的手机号码");
				return;
			}
			var websiteRegExp = /^(?=^.{3,255}$)[a-zA-Z0-9][-a-zA-Z0-9]{0,62}(\.[a-zA-Z0-9][-a-zA-Z0-9]{0,62})+$/;
		...
		$(".mydate").datetimepicker({
			...
			todayBtn:false,//设置是否显示"今天"按钮,默认是false
